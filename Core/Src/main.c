...
int main(void)
{
  ...
  hvcom1.delay_timer_init = vcom_interface_timer_init;
  ...
  vcom_init(&hvcom1);
  while (hvcom1.tx_done == 1) {
    msg_len = snprintf(msg, 200, "%u hello", HAL_GetTick());
